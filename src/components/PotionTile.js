...
function PotionTile({potion, method, children}) {
  console.log(method.name);
  return (
    <div className={(method.name)==="addToInventory"?"card" : "inventory-card"}>
      <div onClick={() => method(potion.id)} className="image-wrapper">
